...
namespace doriax::editor{
    ...
    private:
        ...
        // rows under the Shader row, stored by name in shaderUniforms
        void drawShaderUniformRows(ComponentType cpType, SceneProject* sceneProject, Entity entity, const ShaderUniformRows& rows);
