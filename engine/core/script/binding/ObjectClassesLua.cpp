...
void LuaBinding::registerObjectClasses(lua_State *L){
    ...
    luabridge::getGlobalNamespace(L)
        ...
        .addProperty("pbr", &TerrainSurfaceLayer::pbr)
        .addProperty("colorTexture", &TerrainSurfaceLayer::colorTexture)
        .addProperty("normalTexture", &TerrainSurfaceLayer::normalTexture)
        .addProperty("roughnessTexture", &TerrainSurfaceLayer::roughnessTexture)
        .addProperty("metallicTexture", &TerrainSurfaceLayer::metallicTexture)
        .addProperty("occlusionTexture", &TerrainSurfaceLayer::occlusionTexture)
        .addProperty("heightTexture", &TerrainSurfaceLayer::heightTexture)
        .addProperty("colorFactor", &TerrainSurfaceLayer::colorFactor)
        .addProperty("normalStrength", &TerrainSurfaceLayer::normalStrength)
        .addProperty("roughnessFactor", &TerrainSurfaceLayer::roughnessFactor)
        .addProperty("metallicFactor", &TerrainSurfaceLayer::metallicFactor)
        .addProperty("occlusionStrength", &TerrainSurfaceLayer::occlusionStrength)
        .addProperty("uvScale", &TerrainSurfaceLayer::uvScale)
        .addProperty("uvOffset", &TerrainSurfaceLayer::uvOffset)
        .endClass();
